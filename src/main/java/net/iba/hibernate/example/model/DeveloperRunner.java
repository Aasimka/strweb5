...
public class DeveloperRunner {
    ...
    public static void main(String[] args) {
         ...
         */
        developerRunner.addDeveloper("Olga", "DevOps", "Any systems", 2);
        developerRunner.addDeveloper("Andrey", "Data Engeneer", "Best Developer", 2);
        developerRunner.addDeveloper("Peter", "UI", "Junior Specialist", 4);
        ...
        System.out.println("===================================");
        System.out.println("Removing Some Developer and updating DevOps");
        /*
         * Update and Remove developers
         */
        developerRunner.updateDeveloper(24, 3);
        developerRunner.removeDeveloper(24);
